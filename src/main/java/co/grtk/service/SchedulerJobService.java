...
import co.grtk.component.JobScheduleCreator;
import co.grtk.entity.SchedulerJobInfo;
import co.grtk.job.SampleCronJob;
import co.grtk.job.SimpleJob;
import co.grtk.repository.SchedulerRepository;
...
public class SchedulerJobService {
	...
	public void saveOrUpdate(SchedulerJobInfo scheduleJob) throws Exception {
		if (!ObjectUtils.isEmpty(scheduleJob.getCronExpression())) {
		...
		if (ObjectUtils.isEmpty(scheduleJob.getJobId())) {
